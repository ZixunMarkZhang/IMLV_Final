...
The data set in this project is the [Bank Marketing Data Set](https://archive.ics.uci.edu/ml/datasets/Bank+Marketing) from UC Irvine Machine Learning Repository. It contains the costumer persona of bank client. The feature contains as follows:
