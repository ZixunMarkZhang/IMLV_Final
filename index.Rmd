...
16 - euribor3m: Euro Interbank Offered Rate 3 month rate - daily indicator (numeric)\
...
After the models are built, we will try to visualize the effect of each feature with shapley value plot. Then we will select 5 most influential varaibles from each models, create partial dependent plot, and try to interpret the effect of the variable toward the target variable.
