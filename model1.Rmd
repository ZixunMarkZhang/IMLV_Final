...
```{r message=FALSE, warning=FALSE}
library(pdp)
pdp_hit_rf = partial(object = fullmod,pred.var = 'priceIndex')
...
```{r message=FALSE, warning=FALSE}
library(pdp)
pdp_hit_rf = partial(fullmod,pred.var = 'InterestRateindex')
...
```{r warning=FALSE}
library(pdp)
pdp_hit_rf = partial(fullmod,pred.var = 'campaign')
